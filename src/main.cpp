...
const char* ssid = "Troba";
const char* password = "Shadow1994";
const char* mqttServer = "192.168.32.254";
const int mqttPort = 1883;
const char* mqttUser = "DTSU666";
const char* mqttPassword = "MxY9pVSwjANnk";
